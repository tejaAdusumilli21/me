...
const SECTION_JSON_MAP = window.SECTION_JSON_MAP || {
  ...
  2: './assets/json/Triggers_2.json',
  3: './assets/json/Asynchronous_Apex_3.json',
  4: './assets/json/Salesforce_Integration_4.json',
  5: './assets/json/Visualforce_5.json',
  6: './assets/json/Lightning_Component_Framework_6.json',
  7: './assets/json/Salesforce_Development_Best_Practices_7.json',
  8: './assets/json/Salesforce_Security_Model_8.json',
  9: './assets/json/Testing_&_Debugging_9.json',
  10: './assets/json/Data_Management_&_SOQL_10.json',
  11: './assets/json/Deployment_&_Release_Management_11.json',
  12: './assets/json/Salesforce_Architecture_12.json',
  13: './assets/json/Salesforce_Clouds_&_Products_13.json',
  14: './assets/json/Salesforce_Mobile_14.json',
  15: './assets/json/Salesforce_Communities_15.json',
  16: './assets/json/Salesforce_Reports_&_Dashboards_16.json',
  17: './assets/json/Salesforce_AI_&_Analytics_17.json',
